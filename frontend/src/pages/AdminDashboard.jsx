    ...
    <div className="min-h-screen p-6 md:p-12 relative overflow-hidden bg-dark">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <div className="flex gap-8 border-b border-neutral-800 mb-8 overflow-x-auto overflow-y-hidden whitespace-nowrap scrollbar-hide custom-scrollbar pb-2">
          ...
          <button 
            className={`pb-4 text-lg font-heading tracking-widest uppercase transition-colors relative ${activeTab === 'categories' ? 'text-white' : 'text-neutral-600 hover:text-neutral-400'}`}
            onClick={() => setActiveTab('categories')}
          >
            Categories
            {activeTab === 'categories' && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-primary"></span>}
          </button>
        ...
        {activeTab === 'categories' && (
          <div className="grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-8">
            <div className="bg-card/40 border border-neutral-800 p-6 backdrop-blur-sm shadow-xl h-fit">
              <h2 className="text-xl font-heading text-white mb-2 tracking-widest uppercase">Create Category</h2>
              <p className="text-neutral-400 text-sm mb-6">Add a new photography category.</p>
              <CategoryUploadForm />
            </div>
