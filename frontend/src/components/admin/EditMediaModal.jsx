...
export default function EditMediaModal({ item, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/media/${item._id}`, {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      ...
      >
        ...
        <h2 className="text-2xl font-heading text-white mb-6 uppercase tracking-wider">Edit Media</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            />
            <p className="text-xs text-neutral-500 mt-2">Leave blank to keep existing file.</p>
          </div>
